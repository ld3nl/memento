  ...
  return (
    <>
      ...
      <div className="group m-auto p-4 sm:p-6 lg:p-8">
        <BackButton />
        <h1 className="mb-10 text-center font-display text-3xl italic leading-tight tracking-tight text-zinc-900 dark:text-zinc-50 sm:mb-12 sm:text-4xl lg:text-5xl">
          Your Life in Weeks
          <span className="mt-2 block font-body text-sm font-semibold uppercase tracking-[0.25em] text-zinc-500 dark:text-zinc-400 sm:text-base">
        ...
        <section className="mx-auto mt-16 max-w-3xl border-t-2 border-red-600/20 px-4 pt-16 sm:mt-20 sm:pt-20">
          <div className="border-l-[3px] border-red-600 pl-6 sm:pl-8">
            <div className="font-mono text-5xl font-bold tabular-nums text-red-600 sm:text-6xl lg:text-7xl">
              {weeksLived.toLocaleString()}
            </div>
            <div className="mt-3 font-display text-xs font-semibold uppercase tracking-[0.25em] text-zinc-500 dark:text-zinc-400 sm:text-sm">
              Weeks lived
            </div>

            {weeksRemaining > 0 && (
              <>
                <div className="mt-10 font-mono text-4xl font-bold tabular-nums text-zinc-900 dark:text-zinc-50 sm:mt-12 sm:text-5xl lg:text-6xl">
          ...
          <p className="mt-12 font-body text-base leading-relaxed text-zinc-500 dark:text-zinc-400 sm:mt-16 sm:text-lg">
