...
export function BurstScene({
  ...
  return (
    <div
      ref={containerRef}
      className="relative h-full w-full overflow-hidden border-0 bg-white dark:bg-zinc-950 select-none"
    >
      ...
      {tooltip && (
        <div
          className="pointer-events-none fixed z-50 rounded border-2 border-red-600 bg-zinc-100 dark:bg-zinc-900 px-3 py-1.5 text-xs text-zinc-900 dark:text-zinc-50 shadow-lg backdrop-blur-sm"
          style={{
            left: tooltip.x,
            top: tooltip.y,
