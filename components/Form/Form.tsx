        ...
        <div className="flex flex-col justify-center space-y-5 sm:space-y-6 lg:space-y-8">
          <div className="relative">
            <Image
              ...
              width={177}
              height={141}
              className="mb-4 w-32 opacity-90 contrast-125 grayscale sm:mb-5 sm:w-36 lg:w-44"
              loading="eager"
              priority
            />
          ...
          >
              ...
              {(field) => (
                <>
                  ...
                  {field.state.value &&
                    ...
                    weeksLived !== null && (
                      <div className="animate-in fade-in slide-in-from-bottom-4 mt-6 duration-700 sm:mt-8">
                        <div className="border-[3px] border-red-600 bg-white p-6 shadow-2xl shadow-red-600/10 sm:p-7 lg:p-8 dark:bg-zinc-900">
                          <div className="font-mono text-5xl font-bold tracking-tight text-red-600 tabular-nums sm:text-6xl lg:text-7xl">
                          ...
                          {field.state.value && (
                            <div className="font-display mt-4 border-t border-zinc-200 pt-4 text-sm leading-relaxed text-zinc-500 italic dark:border-zinc-800 dark:text-zinc-400">
            ...
            <div className="flex items-start space-x-3 py-2">
              <input
                ...
                className="mt-0.5 h-5 w-5 flex-shrink-0 cursor-pointer appearance-none rounded-none border-2 border-zinc-200 bg-white text-red-600 transition-all checked:border-red-600 checked:bg-red-600 hover:border-zinc-400 focus:ring-4 focus:ring-red-600/20 focus:ring-offset-2 focus:ring-offset-white focus:outline-none dark:border-zinc-700 dark:bg-zinc-900 dark:hover:border-zinc-600 dark:focus:ring-offset-zinc-950"
                type="checkbox"
                checked={saveData}
                onChange={async (e) => {
              ...
              <label
                ...
                className="cursor-pointer text-sm leading-snug text-zinc-500 transition-colors select-none hover:text-zinc-900 sm:text-base dark:text-zinc-400 dark:hover:text-zinc-50"
              >
