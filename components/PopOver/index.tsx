  ...
  useEffect(() => {
    ...
    if (open) {
      const frame = requestAnimationFrame(() => {
        ...
        const firstFocusable = popoverEl.querySelector<HTMLElement>(focusableSelector);
        if (firstFocusable) {
  ...
  return (
    <>
      <button
        ...
        className={[
          "relative size-2 border text-zinc-500 outline-none transition-colors cursor-pointer",
          ...
          "dark:focus-visible:ring-offset-zinc-950 dark:text-zinc-400",
      ...
      <div
        ...
        style={{ 
          ...
          positionTryFallbacks: "--memento-left, --memento-bottom, --memento-top",
        }}
        className={[
